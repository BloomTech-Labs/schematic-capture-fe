function cov_r2ly5tcmj() {
  var path = "/Users/colin/Documents/lambda/schematic-capture-fe/src/shared/components/Styles/Invite-Styles.js";
  var hash = "e5b8d5b34c49e8463fbc8efe427dac193270a02f";
  var global = new Function("return this")();
  var gcv = "__coverage__";
  var coverageData = {
    path: "/Users/colin/Documents/lambda/schematic-capture-fe/src/shared/components/Styles/Invite-Styles.js",
    statementMap: {
      "0": {
        start: {
          line: 4,
    ...
    hash: "e5b8d5b34c49e8463fbc8efe427dac193270a02f"
  };
...
export const InviteContainer = (cov_r2ly5tcmj().s[0]++, styled.div`
  display: flex;
  ...
  height: 100vh;
`);
export const InviteForm = (cov_r2ly5tcmj().s[1]++, styled.div`
...
`);
export const StyledSelect = (cov_r2ly5tcmj().s[2]++, styled.select`
...
`);
export const InviteGroup = (cov_r2ly5tcmj().s[3]++, styled.div`
  margin-bottom: 1rem;
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
`);
export const InviteGroupBack = (cov_r2ly5tcmj().s[4]++, styled.div``);
export const InviteTitle = (cov_r2ly5tcmj().s[5]++, styled.h1`
  text-align: center;
  color: black;
`);
export const AccessText = (cov_r2ly5tcmj().s[6]++, styled.h4`
  color: black;
`);
