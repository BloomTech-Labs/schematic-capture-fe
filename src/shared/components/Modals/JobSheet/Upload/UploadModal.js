...
import { UploadContainer, UploadForm, UploadField, UploadInput, InputOverlay, FileLabel } from "./Styles";
...
const UploadModal = () => {
  ...
  const handChange = e => {
    ...
    if (file) {
      console.log(file);
      setTheFile(`You are about to upload, ${file.name}.  Press Upload to confirm.`);
